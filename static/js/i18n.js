(function (global) {
    var STRINGS = {
        en: {
            ...
            'nav.recent': 'Recent',
            'nav.noRecent': 'No recent chats',
            'nav.deleteChat': 'Delete chat',
            'nav.deleteConfirm': 'Delete this chat?',
            'nav.menu': 'Menu',
        ...
        my: {
            ...
            'nav.recent': 'လတ်တလော',
            'nav.noRecent': 'လတ်တလော စကားပြော မရှိသေးပါ',
            'nav.deleteChat': 'စကားပြော ဖျက်မည်',
            'nav.deleteConfirm': 'ဤစကားပြောကို ဖျက်မည်လား။',
            'nav.menu': 'မီနူး',
